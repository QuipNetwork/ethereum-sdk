...
/// @title QuipWallet Invariant Test Base
...
///      `super.setUp()`.
abstract contract QuipWalletInvariantBase is QuipFactoryTest {
    QuipWalletInvariantHandler public handler;
    QuipWallet public wallet;
    QuipWallet internal secondImpl;
    ...
    function setUp() public virtual override {
        ...
        handler = new QuipWalletInvariantHandler();
        ...
        // Deploy and vet a second QuipWallet implementation so
        ...
        // deployment.
        secondImpl = new QuipWallet(payable(address(factory)));
        vm.prank(ADMIN);
    ...
    function _initializeHandler() internal {
        ...
        handler.initialize(
            QuipWalletInvariantHandler.InitParams({
                wallet: wallet,
                txnPubs: txnPubs,
                txnPrivs: txnPrivs,
                recPubs: recPubs,
