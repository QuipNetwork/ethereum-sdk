...
contract QuipWallet_isKeySpent is QuipWalletTest {
    function test_isKeySpent_returnsTrueForInstalledTransactionKey()
        public
        view
    {
    ...
    function test_isKeySpent_returnsFalseForUnknownKey() public {
        (WOTSPlus.WinternitzAddress memory unknown, ) = _generateKeyPair(
            "not-installed"
        );
