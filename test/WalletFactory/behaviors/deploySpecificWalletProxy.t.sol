...
contract WalletFactory_deploySpecificWalletProxy is WalletFactoryTest {
    ...
    function test_deploySpecificWalletProxy_deploysProxy() public {
        ...
        vm.prank(ALICE);
        address walletAddr = factory.deploySpecificWalletProxy(commitment, 0, payable(ALICE), payload);
    ...
    function test_deploySpecificWalletProxy_deploysWithBalance() public {
        ...
        vm.prank(ALICE);
        address walletAddr =
            factory.deploySpecificWalletProxy{value: INITIAL_DEPOSIT}(commitment, 0, payable(ALICE), payload);
    ...
    function test_deploySpecificWalletProxy_tracksCommitments() public {
        ...
        vm.startPrank(ALICE);
        factory.deploySpecificWalletProxy(commitment1, 0, payable(ALICE), _encodeInitPayload(pubkey1, rKeys1));
        factory.deploySpecificWalletProxy(commitment2, 0, payable(ALICE), _encodeInitPayload(pubkey2, rKeys2));
        vm.stopPrank();

        assertEq(factory.getCommitmentCount(ALICE), 2);
        assertNotEq(factory.getCommitmentIndex(ALICE, _salt(commitment1)), type(uint256).max);
        assertNotEq(factory.getCommitmentIndex(ALICE, _salt(commitment2)), type(uint256).max);
    }
    ...
    function test_deploySpecificWalletProxy_deploysWithSpecificImpl() public {
        ...
        vm.prank(ALICE);
        address walletAddr = factory.deploySpecificWalletProxy(commitment, 1, payable(ALICE), payload);
    ...
    function test_deploySpecificWalletProxy_creationFeeStaysInFactory() public {
        ...
        vm.prank(ALICE);
        address walletAddr = factory.deploySpecificWalletProxy{value: deposit}(commitment, 0, payable(ALICE), payload);
    ...
    function test_deploySpecificWalletProxy_exactCreationFee() public {
        ...
        vm.prank(ALICE);
        address walletAddr = factory.deploySpecificWalletProxy{value: CREATION_FEE}(commitment, 0, payable(ALICE), payload);
    ...
    function test_deploySpecificWalletProxy_deployerIsNotOwner() public {
        ...
        vm.prank(ALICE);
        address walletAddr = factory.deploySpecificWalletProxy(commitment, 0, payable(BOB), payload);
    ...
    function test_deploySpecificWalletProxy_revertsWhen_indexOutOfBounds() public {
        ...
        factory.deploySpecificWalletProxy(commitment, 999, payable(ALICE), payload);
    }
    ...
    function test_deploySpecificWalletProxy_revertsWhen_insufficientCreationFee() public {
        ...
        factory.deploySpecificWalletProxy{value: sent}(commitment, 0, payable(ALICE), payload);
    }

    function test_deploySpecificWalletProxy_revertsWhen_duplicateCommitment() public {
        ...
        vm.prank(ALICE);
        factory.deploySpecificWalletProxy(commitment, 0, payable(ALICE), payload1);
        ...
        factory.deploySpecificWalletProxy(commitment, 0, payable(ALICE), payload2);
    }

    function test_deploySpecificWalletProxy_revertsWhen_sameCommitmentDifferentSenders() public {
        ...
        vm.prank(BOB);
        vm.expectRevert(CREATE3.DeploymentFailed.selector);
        factory.deploySpecificWalletProxy(commitment, 0, payable(BOB), payload2);
    }
    ...
    function test_deploySpecificWalletProxy_revertsWhen_toIsZeroAddress() public {
        ...
        factory.deploySpecificWalletProxy(commitment, 0, payable(address(0)), payload);
    }
}
