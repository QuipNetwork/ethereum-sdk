...
contract WalletFactory_deploySpecificWalletProxy is WalletFactoryTest {
    ...
    function test_deploySpecificWalletProxy_deploysProxy() public {
        ...
        assertNotEq(
            factory.getCommitmentIndex(ALICE, _salt(commitment)),
            type(uint256).max
        );
    ...
    function test_deploySpecificWalletProxy_tracksCommitments() public {
        ...
        assertNotEq(
            factory.getCommitmentIndex(ALICE, _salt(commitment1)),
            type(uint256).max
        );
        assertNotEq(
            factory.getCommitmentIndex(ALICE, _salt(commitment2)),
            type(uint256).max
        );
    }
    ...
    function test_deploySpecificWalletProxy_deploysWithSpecificImpl() public {
        ...
        WOTSPlusImplementation impl2 = new WOTSPlusImplementation(
    ...
    function test_deploySpecificWalletProxy_deployerIsNotOwner() public {
        ...
        assertEq(factory.wallets(_salt(commitment)), walletAddr);
        assertNotEq(
            factory.getCommitmentIndex(BOB, _salt(commitment)),
            type(uint256).max
        );
    }
