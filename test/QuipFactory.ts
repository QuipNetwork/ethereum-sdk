...
describe("QuipFactory", function () {
  ...
  async function deployQuipFactory() {
    ...
    const deployGasFee = quipFactoryDeployReceipt!.gasUsed * quipFactoryDeployReceipt!.gasPrice;
    console.log(`QuipFactory deploy gas used: ${quipFactoryDeployReceipt!.gasUsed} units`);
    console.log(`QuipFactory deploy gas price: ${quipFactoryDeployReceipt!.gasPrice} wei`);
    console.log(`QuipFactory deploy total gas fee: ${hre.ethers.formatEther(deployGasFee)} ETH`);
