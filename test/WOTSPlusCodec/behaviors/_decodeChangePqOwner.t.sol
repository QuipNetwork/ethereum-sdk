...
contract WOTSPlusCodec__decodeChangePqOwner is WOTSPlusCodecTest {
    function test_exposed_decodeChangePqOwner_decodesCorrectly() public view {
        ...
        (WOTSPlus.WinternitzAddress memory pq, WOTSPlus.WinternitzElements memory sig) =
            codec.exposed_decodeChangePqOwner(payload);
