...
contract WOTSPlusCodec__transferOwnershipDigest is WOTSPlusCodecTest {
    ...
    function test_exposed_transferOwnershipDigest_matchesManualHash()
        public
        view
    {
        ...
        assertEq(
            codec.exposed_transferOwnershipDigest(
                W,
                C,
                S1,
                H1,
    ...
    function test_exposed_transferOwnershipDigest_differsByNewOwner()
        public
        view
    {
        bytes32 a = codec.exposed_transferOwnershipDigest(
            W,
            C,
            S1,
            H1,
        ...
        bytes32 b = codec.exposed_transferOwnershipDigest(
            W,
            C,
            S1,
            H1,
    ...
    function test_exposed_transferOwnershipDigest_differsByWallet()
        public
        view
    {
        bytes32 a = codec.exposed_transferOwnershipDigest(
    ...
    function test_exposed_transferOwnershipDigest_differsByChainId()
        public
        view
    {
        bytes32 a = codec.exposed_transferOwnershipDigest(
    ...
    function test_exposed_transferOwnershipDigest_differsByKeysHash()
        public
        view
    {
        bytes32 a = codec.exposed_transferOwnershipDigest(
