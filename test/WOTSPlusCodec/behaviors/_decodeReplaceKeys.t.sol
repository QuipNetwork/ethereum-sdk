...
contract WOTSPlusCodec__decodeReplaceKeys is WOTSPlusCodecTest {
    function test_exposed_decodeReplaceKeys_decodesN1() public view {
        bytes memory payload = _buildReplaceKeysPayload(
            30,
            1,
        ...
        WOTSPlusCodecHarness.DecodedReplaceKeys memory out = codec
            .exposed_decodeReplaceKeys(payload);
    ...
    function test_exposed_decodeReplaceKeys_revertsWhen_lengthMismatch_nTooLarge()
        public
    {
    ...
    function test_exposed_decodeReplaceKeys_revertsWhen_lengthMismatch_nTooSmall()
        public
    {
    ...
    function test_exposed_decodeReplaceKeys_revertsWhen_kindOutOfRange()
        public
    {
    ...
    function test_exposed_decodeReplaceKeys_revertsWhen_signingKindOutOfRange()
        public
    {
        bytes memory payload = _buildReplaceKeysPayload(
            30,
    ...
    function testFuzz_exposed_decodeReplaceKeys_revertsWhen_short(
        uint256 len
    ) public {
    ...
    function testFuzz_exposed_decodeReplaceKeys_revertsWhen_lengthMismatch(
        uint256 len
    ) public {
