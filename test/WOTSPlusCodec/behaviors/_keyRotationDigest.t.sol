...
contract WOTSPlusCodec__keyRotationDigest is WOTSPlusCodecTest {
    ...
    function test_exposed_keyRotationDigest_matchesManualHash() public view {
        ...
        assertEq(
            codec.exposed_keyRotationDigest(W, C, S1, H1, S2, H2),
            expected
        );
    }
    ...
    function test_exposed_keyRotationDigest_differsByWallet() public view {
        bytes32 a = codec.exposed_keyRotationDigest(
            address(0x1),
            C,
            S1,
            H1,
        ...
        bytes32 b = codec.exposed_keyRotationDigest(
            address(0x2),
            C,
            S1,
            H1,
    ...
    function test_exposed_keyRotationDigest_differFromKeysetDigest()
        public
        view
    {
        bytes32 kr = codec.exposed_keyRotationDigest(W, C, S1, H1, S2, H2);
        bytes32 km = codec.exposed_keysetDigest(
