...
contract WOTSPlusCodec__decodeRecoveryUpgradeAuth is WOTSPlusCodecTest {
    ...
    function test_exposed_decodeRecoveryUpgradeAuth_decodesCurrentKey()
        public
        view
    {
        bytes memory payload = _buildRecoveryUpgradePayload(7);
        (WOTSPlus.WinternitzAddress memory cur, , ) = codec
            .exposed_decodeRecoveryUpgradeAuth(payload);
    ...
    function test_exposed_decodeRecoveryUpgradeAuth_revertsWhen_emptyPayload()
        public
    {
        vm.expectRevert(
    ...
    function test_exposed_decodeRecoveryUpgradeAuth_revertsWhen_wrongLength()
        public
    {
        vm.expectRevert(
            abi.encodeWithSelector(
