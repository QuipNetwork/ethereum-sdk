...
contract WOTSPlusCodec__verificationDigest is WOTSPlusCodecTest {
    ...
    function test_exposed_verificationDigest_matchesManualHash() public view {
        ...
        assertEq(
            codec.exposed_verificationDigest(W, C, impl, S1, H1),
            expected
        );
    }

    function test_exposed_verificationDigest_differsByImplementation()
        public
        view
    {
        bytes32 a = codec.exposed_verificationDigest(
            W,
            C,
            address(0x1),
            S1,
        ...
        bytes32 b = codec.exposed_verificationDigest(
            W,
            C,
            address(0x2),
            S1,
