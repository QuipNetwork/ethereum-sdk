...
contract QuipFactory_deploySpecificWalletProxy is QuipFactoryTest {
    ...
    function test_deploySpecificWalletProxy_deploysWithBalance() public {
        ...
        vm.prank(ALICE);
        address walletAddr = factory.deploySpecificWalletProxy{value: INITIAL_DEPOSIT}(
    ...
    function test_deploySpecificWalletProxy_exactCreationFee() public {
        ...
        vm.prank(ALICE);
        address walletAddr = factory.deploySpecificWalletProxy{value: CREATION_FEE}(
            vaultId, 0, payable(ALICE), payload
        );
