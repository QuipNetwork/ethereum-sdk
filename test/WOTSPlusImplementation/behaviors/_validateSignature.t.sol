...
contract WOTSPlusImplementation__validateSignature is WOTSPlusImplementationTest {
        ...
        public
    {
        ...
        emit IWOTSPlusImplementation.UserOpValidationRejected(
            IWOTSPlusImplementation.UserOpValidationFailure.ZeroNextKey
        );
        uint256 rv = harnessProxy.exposed_validateSignature(op, userOpHash);
        assertEq(rv, 1);
    }
        ...
        public
    {
        ...
        vm.expectEmit(address(harnessProxy));
        emit IWOTSPlusImplementation.UserOpValidationRejected(
            IWOTSPlusImplementation.UserOpValidationFailure.StaleCurrentKey
        );
        uint256 rv = harnessProxy.exposed_validateSignature(op, userOpHash);
        assertEq(rv, 1);
    }
        ...
        public
    {
        ...
        vm.expectEmit(address(harnessProxy));
        emit IWOTSPlusImplementation.UserOpValidationRejected(
            IWOTSPlusImplementation.UserOpValidationFailure.NextKeyAlreadyInUse
        );
        uint256 rv = harnessProxy.exposed_validateSignature(op, userOpHash);
        assertEq(rv, 1);
    }
        ...
        public
    {
        ...
        vm.expectEmit(address(harnessProxy));
        emit IWOTSPlusImplementation.UserOpValidationRejected(
            IWOTSPlusImplementation.UserOpValidationFailure.InvalidSignature
        );
        uint256 rv = harnessProxy.exposed_validateSignature(op, userOpHash);
        assertEq(rv, 1);
