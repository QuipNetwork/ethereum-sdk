...
contract WOTSPlusImplementation_isKey is WOTSPlusImplementationTest {
    ...
    function test_isKey_transactionReturnsFalseForUnregisteredKey() public {
        (WOTSPlus.WinternitzAddress memory other,) = _generateKeyPair("not-a-txn-key");
    ...
    function test_isKey_verificationReturnsFalseForAllNonMembersInEagerPhase() public {
