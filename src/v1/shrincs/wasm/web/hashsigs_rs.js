 ...
 * @returns {boolean}
 */
export function shrincs_verify_stateless_action(parameter_set_id, expected_public_key_commitment_hex, public_key, context, signature) {
 ...
 * @returns {boolean}
 */
export function shrincs_verify_stateless_raw(parameter_set_id, expected_public_key_commitment_hex, public_key, message_hex, signature) {
    const ptr0 = passStringToWasm0(parameter_set_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(expected_public_key_commitment_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {string[]}
 */
export function supported_parameter_sets() {
 ...
 * @returns {string}
 */
export function shrincsStatefulRotationMessageHash(parameter_set_id, expected_public_key_commitment_hex, current_public_key, context, next_key) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(parameter_set_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function shrincsStatefulActionMessageHash(parameter_set_id, expected_public_key_commitment_hex, context) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(parameter_set_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {boolean}
 */
export function shrincs_verify_stateful_action(parameter_set_id, expected_public_key_commitment_hex, public_key, context, signature) {
    const ptr0 = passStringToWasm0(parameter_set_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(expected_public_key_commitment_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {string}
 */
export function shrincsFullRotationMessageHash(parameter_set_id, expected_public_key_commitment_hex, current_public_key, context, next_key) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(parameter_set_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {boolean}
 */
export function shrincs_verify_stateful_raw(parameter_set_id, expected_public_key_commitment_hex, public_key, message_hex, signature) {
    const ptr0 = passStringToWasm0(parameter_set_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(expected_public_key_commitment_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {string}
 */
export function shrincsStatelessActionMessageHash(parameter_set_id, expected_public_key_commitment_hex, context) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(parameter_set_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 */
export function shrincsKeygen(parameter_set_id, seed_hex, max_stateful_signatures) {
    const ptr0 = passStringToWasm0(parameter_set_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
const WasmShrincsAccountFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmshrincsaccount_free(ptr >>> 0, 1));
...
export class WasmShrincsAccount {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmShrincsAccountFinalization.unregister(this);
        return ptr;
    }
    ...
    rotateFullKey(current_public_key, recovery_signature, next_key) {
        const ret = wasm.wasmshrincsaccount_rotateFullKey(this.__wbg_ptr, current_public_key, recovery_signature, next_key);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] !== 0;
    ...
    /**
     * @param {string} caller_hex
     */
    enterRecoveryMode(caller_hex) {
        const ptr0 = passStringToWasm0(caller_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmshrincsaccount_enterRecoveryMode(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
    ...
    rotateToFreshKey(current_public_key, recovery_signature, next_key) {
        const ret = wasm.wasmshrincsaccount_rotateToFreshKey(this.__wbg_ptr, current_public_key, recovery_signature, next_key);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] !== 0;
    ...
    verifyStatefulAction(public_key, action_type_hex, payload_hash_hex, signature) {
        const ptr0 = passStringToWasm0(action_type_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(payload_hash_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmshrincsaccount_verifyStatefulAction(this.__wbg_ptr, public_key, ptr0, len0, ptr1, len1, signature);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] !== 0;
    ...
    verifyStatelessAction(public_key, action_type_hex, payload_hash_hex, signature) {
        ...
        const ptr1 = passStringToWasm0(payload_hash_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmshrincsaccount_verifyStatelessAction(this.__wbg_ptr, public_key, ptr0, len0, ptr1, len1, signature);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] !== 0;
     ...
     * @param {string} caller_hex
     */
    setStatefulPolicyLeafBitmap(caller_hex) {
        const ptr0 = passStringToWasm0(caller_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmshrincsaccount_setStatefulPolicyLeafBitmap(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    /**
     * @param {string} caller_hex
     * @param {number} initial_leaf_index
     */
    setStatefulPolicyMonotonicIndex(caller_hex, initial_leaf_index) {
        const ptr0 = passStringToWasm0(caller_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmshrincsaccount_setStatefulPolicyMonotonicIndex(this.__wbg_ptr, ptr0, len0, initial_leaf_index);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {string} caller_hex
     */
    setStatefulPolicyRecoveryRotation(caller_hex) {
        const ptr0 = passStringToWasm0(caller_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmshrincsaccount_setStatefulPolicyRecoveryRotation(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    /**
     * @param {string} owner_hex
     * @param {string} chain_id_hex
     * @param {string} contract_address_hex
     * @param {string} initial_public_key_commitment_hex
     */
    constructor(owner_hex, chain_id_hex, contract_address_hex, initial_public_key_commitment_hex) {
        const ptr0 = passStringToWasm0(owner_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(chain_id_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(contract_address_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(initial_public_key_commitment_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.wasmshrincsaccount_new(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        WasmShrincsAccountFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @returns {any}
...
const WasmShrincsKeypairFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmshrincskeypair_free(ptr >>> 0, 1));

export class WasmShrincsKeypair {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WasmShrincsKeypair.prototype);
        obj.__wbg_ptr = ptr;
        WasmShrincsKeypairFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmShrincsKeypairFinalization.unregister(this);
        return ptr;
    }
    ...
    signStatefulRaw(message_hex) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmshrincskeypair_signStatefulRaw(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    signStatelessRaw(message_hex) {
        const ptr0 = passStringToWasm0(message_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmshrincskeypair_signStatelessRaw(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    signStatefulRawAt(message_hex, leaf) {
        const ptr0 = passStringToWasm0(message_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmshrincskeypair_signStatefulRawAt(this.__wbg_ptr, ptr0, len0, leaf);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('hashsigs_rs_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
