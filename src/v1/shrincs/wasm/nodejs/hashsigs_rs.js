...
module.exports.WasmShrincsAccount = WasmShrincsAccount;
...
module.exports.WasmShrincsKeypair = WasmShrincsKeypair;
...
const path = require('path').join(__dirname, 'hashsigs_rs_bg.wasm');
