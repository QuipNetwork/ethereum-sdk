...
// NOTE: the WOTS+-client-only error classes (Erc4337WalletValidationError,
// Erc4337PaymasterValidationError, WalletNotInitializedError,
// InvalidSignerError, NotConnectedError, MulticallUnavailableError,
// KeyAlreadyBurnedError, KeyDerivationSelfTestError,
// PartialMulticallResultError) moved to `src/deprecated/v1/errors.ts` with
// the WOTS+ family sunset. The classes below remain live because shared
// runtime infrastructure (decodeError registry, providerState, multicall,
// the SHRINCS clients) references them.
