    ...
    Initializable
{
    ...
    ///      WOTSPlusImplementation cannot be replayed against another with the same
    ...
    function renounceOwnership()
        public
        payable
        override(IWOTSPlusImplementation, Ownable)
        onlyOwner
    {
    ...
    ///      is required because both `IWOTSPlusImplementation` and `Ownable` declare it.
    function owner()
        public
        view
        override(IWOTSPlusImplementation, Ownable)
    ...
    ///      A sig forged for one WOTSPlusImplementation cannot be replayed against
    ...
    function _checkErc1271Signature(
        ...
        // crafted for one WOTSPlusImplementation cannot be replayed against another with
    ...
    ///      response. Index mapping is documented on the error in `IWOTSPlusImplementation`.
